...
const translations = {
  en: {
    ...
    events: 'Events',
    insights: 'Insights',
    insightsSubtitle: 'AI-powered suggestions for your family',
    familySetupRequired: 'Family Setup Required',
    insightsRequireFamily: 'Create a family and add events to see AI-powered insights.',
    admin: 'Admin',
  ...
  membersSelectedOne: '1 member selected',
  membersSelectedMany: '{count} members selected',
  ...
  nl: {
    ...
    events: 'Evenementen',
    insights: 'Inzichten',
    insightsSubtitle: 'AI-gestuurde suggesties voor je gezin',
    familySetupRequired: 'Gezinsinstelling vereist',
    insightsRequireFamily: 'Maak een gezin aan en voeg evenementen toe om AI-gestuurde inzichten te zien.',
    admin: 'Beheer',
